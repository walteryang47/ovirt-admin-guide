...
|**/tmp/ovirt-host-deploy-@DATE@.log**|部署主机所生成的日志，当主机成功部署完成后，会将该日志文件复制到 oVirt Manager 中，以文件 /var/log/ovirt-engine/host-deploy/ovirt-@DATE@-@HOST@-@CORRELATION\_ID@.log 得形式保存在 Manager 中。|
